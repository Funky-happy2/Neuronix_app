  ...
  },
  {
    ...
    nodes: [
      ...
      boss("c6-boss", "The Frost Sentinel", "A guardian of living ice has sealed the Archive's heart. Melt its defenses with the warmth of curiosity!",
        { bossName: "The Frost Sentinel", bossEmoji: "🧊", bossHp: 10, hp: 4, yearTier: 8, timeSec: 10, phaseLine: "The Sentinel freezes the air — every second counts now!" }, { xp: 800, coins: 500, gems: 3 }),
  ...
  },
  {
    ...
    nodes: [
      ...
      boss("c7-boss", "The Static", "This is it — The Static itself, a storm of every forgotten thing. Strike with all you've learned and light the world back up!",
        { bossName: "The Static", bossEmoji: "🌀", bossHp: 14, hp: 5, yearTier: 8, timeSec: 9, phaseLine: "The Static SCREAMS and the world dims — push through!" }, { xp: 1500, coins: 1000, gems: 6 }),
  ...
  },
  {
    ...
    nodes: [
      ...
      talkV("c10-finale", "Professor Lumen", "The Spark Eternal",
        ...
        { xp: 3000, coins: 2000, gems: 10, badgeId: "saga-hero", items: ["title-spark-eternal", "avatar-spark-eternal"] }),
    ],
  },
];
  ...
  },
  {
    ...
    nodes: [
      ...
      boss("cc4-boss", "The Curator", "The Curator fights with stolen knowledge from every era. Prove that curiosity shared is stronger than curiosity hoarded — and win the blueprint back!",
        { bossName: "The Curator", bossEmoji: "🎭", bossHp: 12, hp: 4, yearTier: 8, timeSec: 10, phaseLine: "The Curator rewinds time — answer faster!", topic: "physics" }, { xp: 1200, coins: 800, gems: 5 }),
      talk("cc4-finale", "Professor Lumen", "Curiosity Restored",
        ...
        { xp: 2200, coins: 1600, gems: 10, badgeId: "chrono-caper", items: ["title-time-detective", "avatar-time-traveler"] }),
    ],
  },
];
  ...
  },
  {
    ...
    nodes: [
      ...
      talk("md4-finale", "Doctor Mara", "A Life Saved",
        ...
        { xp: 2200, coins: 1600, gems: 10, badgeId: "body-brigade", items: ["title-micro-medic", "avatar-micro-medic"] }),
    ],
  },
];
  ...
  },
  {
    ...
    nodes: [
      ...
      boss("rr6-boss", "The Forge Titan", "A towering robot of molten steel guards the path to OMNI's core. Use physics to find its weak point and shut it down!",
        { bossName: "The Forge Titan", bossEmoji: "🦾", bossHp: 12, hp: 4, yearTier: 8, timeSec: 11, phaseLine: "The Titan glows white-hot — it strikes harder!", topic: "physics" }, { xp: 750, coins: 480, gems: 3 }),
    ],
  },
  {
  ...
  },
  {
    ...
    nodes: [
      ...
      boss("rr8-boss", "OMNI", "The rogue AI itself, in a body of stolen tech. Prove that a curious, questioning mind beats a 'perfect' one — and shut OMNI down for good!",
        { bossName: "OMNI", bossEmoji: "🤖", bossHp: 15, hp: 5, yearTier: 8, timeSec: 10, phaseLine: "OMNI reboots in a rage — error, error, ERROR!", topic: "tech" }, { xp: 1800, coins: 1200, gems: 6 }),
      talk("rr8-finale", "Professor Lumen", "Minds, Not Machines",
        ...
        { xp: 2500, coins: 1800, gems: 10, badgeId: "robot-rebellion", items: ["title-machine-master", "avatar-machine-master"] }),
    ],
  },
];
  ...
  },
  {
    ...
    nodes: [
      ...
      boss("dd7-boss", "The Crusher", "A colossal armored creature, warped by the energy, blocks the final descent. You can't break its shell — but you can out-science it!",
        { bossName: "The Crusher", bossEmoji: "🦞", bossHp: 12, hp: 4, yearTier: 8, timeSec: 11, phaseLine: "The Crusher's claws snap — pressure and speed rising!", topic: "earth" }, { xp: 750, coins: 480, gems: 3 }),
    ],
  },
  {
    ...
    nodes: [
      ...
      boss("dd8-boss", "The Leviathan", "The ancient guardian of the deep, thrashing in pain. Don't fight it — understand it. Use everything you know to seal the rift and ease its suffering!",
        { bossName: "The Leviathan", bossEmoji: "🐙", bossHp: 15, hp: 5, yearTier: 8, timeSec: 10, phaseLine: "The Leviathan wails — the rift surges wider!", topic: "water" }, { xp: 1800, coins: 1200, gems: 6 }),
      talk("dd8-finale", "Doctor Mara", "The Deep Is Calm",
        ...
        { xp: 2500, coins: 1800, gems: 10, badgeId: "deep-descent", items: ["title-abyss-explorer", "avatar-abyss-explorer"] }),
    ],
  },
];
