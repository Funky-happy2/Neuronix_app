    ...
    try {
      const existing = await storage.getShopItems();
      {
        ...
        const items = [
          ...
          { id: "powerup-daily-double", name: "Daily Double", description: "Double the XP and coin rewards from daily challenges", category: "powerup", price: 250, icon: "Rocket", rarity: "uncommon", requiredLevel: 2, requiredRebirth: 0, requiredXp: 0, rewardSource: null },
          ...
          { id: "coin-style-supreme-champion", name: "Supreme Champion Coins", description: "Your coins radiate with champion gold energy - exclusive to the #1 ranked player.", category: "coin_style", price: 0, icon: "Crown", rarity: "legendary", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "leaderboard:individual" },
          { id: "gem-style-supreme-champion", name: "Supreme Champion Gems", description: "Your gems blaze with golden champion light - exclusive to the #1 ranked player.", category: "gem_style", price: 0, icon: "Crown", rarity: "legendary", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "leaderboard:individual" },
          ...
          { id: "coin-style-clan-champion", name: "Clan Champion Coins", description: "Your coins glow with clan steel-blue energy - for members of the #1 ranked clan.", category: "coin_style", price: 0, icon: "Shield", rarity: "epic", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "leaderboard:clan" },
          { id: "gem-style-clan-champion", name: "Clan Champion Gems", description: "Your gems shimmer with steel-blue clan energy - for members of the #1 ranked clan.", category: "gem_style", price: 0, icon: "Shield", rarity: "epic", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "leaderboard:clan" },
          ...
          { id: "coin-style-team-champion", name: "Team Champion Coins", description: "Your coins glow with team purple energy - for members of the #1 ranked team.", category: "coin_style", price: 0, icon: "Star", rarity: "legendary", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "leaderboard:team" },
          { id: "gem-style-team-champion", name: "Team Champion Gems", description: "Your gems pulse with team purple energy - for members of the #1 ranked team.", category: "gem_style", price: 0, icon: "Star", rarity: "legendary", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "leaderboard:team" },
          ...
          { id: "coin-style-default", name: "Classic Coins", description: "The standard gold coin display", category: "coin_style", price: 0, icon: "Coins", rarity: "common", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: null },
          { id: "coin-style-diamond", name: "Diamond Coins", description: "Your coins sparkle like cut diamonds", category: "coin_style", price: 500, icon: "Diamond", rarity: "uncommon", requiredLevel: 5, requiredRebirth: 0, requiredXp: 0, rewardSource: null },
          { id: "coin-style-fire", name: "Molten Coins", description: "Your coins glow with a fiery orange lava effect", category: "coin_style", price: 1000, icon: "Flame", rarity: "rare", requiredLevel: 8, requiredRebirth: 0, requiredXp: 500, rewardSource: null },
          { id: "coin-style-ice", name: "Frozen Coins", description: "Your coins shimmer with an icy blue frost effect", category: "coin_style", price: 1500, icon: "Snowflake", rarity: "epic", requiredLevel: 12, requiredRebirth: 1, requiredXp: 2000, rewardSource: null },
          { id: "coin-style-rainbow", name: "Prismatic Coins", description: "Your coins cycle through rainbow colors", category: "coin_style", price: 2500, icon: "Rainbow", rarity: "legendary", requiredLevel: 16, requiredRebirth: 3, requiredXp: 8000, rewardSource: null },
          { id: "gem-style-default", name: "Classic Gems", description: "The standard purple gem display", category: "gem_style", price: 0, icon: "Gem", rarity: "common", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: null },
          { id: "gem-style-emerald", name: "Emerald Gems", description: "Your gems glow with a rich emerald green", category: "gem_style", price: 500, icon: "Gem", rarity: "uncommon", requiredLevel: 5, requiredRebirth: 0, requiredXp: 0, rewardSource: null },
          { id: "gem-style-ruby", name: "Ruby Gems", description: "Your gems burn with a deep ruby red", category: "gem_style", price: 1000, icon: "Gem", rarity: "rare", requiredLevel: 8, requiredRebirth: 0, requiredXp: 500, rewardSource: null },
          { id: "gem-style-sapphire", name: "Sapphire Gems", description: "Your gems shimmer with a royal sapphire blue", category: "gem_style", price: 1500, icon: "Gem", rarity: "epic", requiredLevel: 12, requiredRebirth: 1, requiredXp: 2000, rewardSource: null },
          { id: "gem-style-cosmic", name: "Cosmic Gems", description: "Your gems pulse with swirling galaxy energy", category: "gem_style", price: 2500, icon: "Gem", rarity: "legendary", requiredLevel: 16, requiredRebirth: 3, requiredXp: 8000, rewardSource: null },
          { id: "coin-style-plasma", name: "Plasma Coins", description: "Your coins crackle with electric plasma energy - earned by defeating all 8 regular bosses", category: "coin_style", price: 0, icon: "Zap", rarity: "epic", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "boss:all-regular" },
          { id: "coin-style-void", name: "Void Coins", description: "Your coins shimmer with dark antimatter - earned by conquering all 10 world bosses", category: "coin_style", price: 0, icon: "Moon", rarity: "legendary", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "boss:all-world" },
          { id: "coin-style-champion", name: "Champion Coins", description: "Your coins gleam with tournament gold - awarded for winning a tournament", category: "coin_style", price: 0, icon: "Trophy", rarity: "epic", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "tournament:winner" },
          { id: "coin-style-toxic", name: "Toxic Coins", description: "Your coins ooze with a sickly green glow - from defeating Plague Lord", category: "coin_style", price: 0, icon: "Bug", rarity: "epic", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "boss:plague-lord" },
          { id: "coin-style-nebula", name: "Nebula Coins", description: "Your coins swirl with cosmic nebula colors - from defeating the Nebula Queen", category: "coin_style", price: 0, icon: "Orbit", rarity: "epic", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "boss:nebula-queen" },
          { id: "gem-style-lightning", name: "Lightning Gems", description: "Your gems spark with crackling electricity - from defeating the Thunder King", category: "gem_style", price: 0, icon: "Zap", rarity: "epic", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "boss:thunder-king" },
          { id: "gem-style-void", name: "Void Gems", description: "Your gems pulse with dark energy from the void - earned by defeating all 10 world bosses", category: "gem_style", price: 0, icon: "Moon", rarity: "legendary", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "boss:all-world" },
          { id: "gem-style-champion", name: "Champion Gems", description: "Your gems shine with victorious golden light - awarded for winning a tournament", category: "gem_style", price: 0, icon: "Trophy", rarity: "epic", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "tournament:winner" },
          { id: "gem-style-frost", name: "Frost Gems", description: "Your gems glitter with frozen ice crystals - from defeating the Frost Wyrm", category: "gem_style", price: 0, icon: "Snowflake", rarity: "epic", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "boss:frost-wyrm" },
          { id: "gem-style-magma", name: "Magma Gems", description: "Your gems burn with molten lava energy - from defeating the Magma Titan", category: "gem_style", price: 0, icon: "Flame", rarity: "epic", requiredLevel: 1, requiredRebirth: 0, requiredXp: 0, rewardSource: "boss:magma-titan" },
          ...
          { id: "powerup-xp-surge", name: "XP & Coin Surge", description: "Permanently earn +20% more XP AND +20% more coins from every game and challenge!", category: "powerup", price: 2800, icon: "TrendingUp", rarity: "legendary", requiredLevel: 15, requiredRebirth: 2, requiredXp: 8000, rewardSource: null },
