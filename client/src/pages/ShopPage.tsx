...
const GEM_UPGRADES: { id: string; name: string; description: string; icon: string; price: number; rarity: string; requiredLevel?: number }[] = [
  ...
  { id: "upgrade-coin-magnet", name: "Neuro Magnet", description: "Earn +25% Neuros from boss battles! (1 use per game)", icon: "Neuros", price: 8, rarity: "rare" },
  ...
  { id: "upgrade-double-coins", name: "Double Neuros", description: "Earn 2x Neuros from all games! (1 use per game)", icon: "Neuros", price: 20, rarity: "legendary", requiredLevel: 15 },
  { id: "upgrade-boss-rush", name: "Boss Rush Mode", description: "Earn 1.5x XP and Neuros from all boss battles! (1 use per fight)", icon: "Swords", price: 25, rarity: "legendary", requiredLevel: 20 },
  { id: "upgrade-lab-mastery", name: "Lab Mastery", description: "Earn 3x XP and Neuros from all lab experiments! (1 use per lab)", icon: "FlaskConical", price: 30, rarity: "legendary", requiredLevel: 25 },
  ...
  { id: "upgrade-permanent-coins", name: "Neuro Mastery", description: "Permanently earn +15% Neuros from all games forever!", icon: "Wallet", price: 45, rarity: "legendary", requiredLevel: 15 },
  { id: "upgrade-daily-gems", name: "Daily Sparks", description: "Earn +2 bonus Sparks every time you claim daily rewards! (Permanent)", icon: "Gift", price: 50, rarity: "legendary", requiredLevel: 20 },
  ...
  { id: "upgrade-treasure-hunter", name: "Treasure Hunter", description: "Find 5-15 bonus Neuros hidden in every game! (Permanent)", icon: "Search", price: 35, rarity: "epic", requiredLevel: 10 },
  ...
  { id: "upgrade-science-star", name: "Science Star", description: "Permanently earn +10% XP AND +10% Neuros from everything!", icon: "Star", price: 55, rarity: "legendary", requiredLevel: 30 },
  ...
  { id: "upgrade-mega-coins", name: "Mega Neuro Core", description: "Permanently earn +25% Neuros from all games forever! Stacks with Neuro Mastery!", icon: "Neuros", price: 70, rarity: "legendary", requiredLevel: 35 },
  { id: "upgrade-scholar", name: "Grand Scholar", description: "Permanently earn +20% XP AND +20% Neuros from everything!", icon: "TrendingUp", price: 90, rarity: "legendary", requiredLevel: 40 },
  { id: "upgrade-jackpot", name: "Jackpot Core", description: "Each game has a 10% chance to TRIPLE all your XP and Neuros!", icon: "Sparkles", price: 100, rarity: "legendary", requiredLevel: 45 },
];
